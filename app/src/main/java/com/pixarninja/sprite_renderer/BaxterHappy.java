...
public class BaxterHappy extends SpriteCharacter {

    public BaxterHappy(Resources res, double percentOfScreen, int xRes, int yRes, int width, int height) {
